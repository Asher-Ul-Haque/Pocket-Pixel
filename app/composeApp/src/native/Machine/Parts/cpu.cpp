...
static Instruction instructions[POSSIBLE_INSTRUCTION_COUNT] =
{
    // - - - Hex because easy to reference here: https://meganesulli.com/static/851d34afbc4673ee915a8233fda67922/78d47/opcode-tables-screenshot.png
        ...
        //0xAX
        [0xA0] = {INSTRUCTION_AND, ADDRESS_MODE_R_R, REG_A, REG_B},
        [0xA1] = {INSTRUCTION_AND, ADDRESS_MODE_R_R, REG_A, REG_C},
        [0xA2] = {INSTRUCTION_AND, ADDRESS_MODE_R_R, REG_A, REG_D},
        [0xA3] = {INSTRUCTION_AND, ADDRESS_MODE_R_R, REG_A, REG_E},
        [0xA4] = {INSTRUCTION_AND, ADDRESS_MODE_R_R, REG_A, REG_H},
        [0xA5] = {INSTRUCTION_AND, ADDRESS_MODE_R_R, REG_A, REG_L},
        [0xA6] = {INSTRUCTION_AND, ADDRESS_MODE_MR_R, REG_A, REG_HL},
        [0xA7] = {INSTRUCTION_AND, ADDRESS_MODE_R_R, REG_A, REG_A},
        [0xA8] = {INSTRUCTION_XOR, ADDRESS_MODE_R_R, REG_A, REG_B},
        [0xA9] = {INSTRUCTION_XOR, ADDRESS_MODE_R_R, REG_A, REG_C},
        [0xAA] = {INSTRUCTION_XOR, ADDRESS_MODE_R_R, REG_A, REG_D},
        [0xAB] = {INSTRUCTION_XOR, ADDRESS_MODE_R_R, REG_A, REG_E},
        [0xAC] = {INSTRUCTION_XOR, ADDRESS_MODE_R_R, REG_A, REG_H},
        [0xAD] = {INSTRUCTION_XOR, ADDRESS_MODE_R_R, REG_A, REG_L},
        [0xAE] = {INSTRUCTION_XOR, ADDRESS_MODE_MR, REG_A, REG_HL},
        [0xAF] = {INSTRUCTION_XOR, ADDRESS_MODE_R, REG_A, REG_A},

        //0xBX
        [0xB0] = {INSTRUCTION_OR, ADDRESS_MODE_R_R, REG_A, REG_B},
        [0xB1] = {INSTRUCTION_OR, ADDRESS_MODE_R_R, REG_A, REG_C},
        [0xB2] = {INSTRUCTION_OR, ADDRESS_MODE_R_R, REG_A, REG_D},
        [0xB3] = {INSTRUCTION_OR, ADDRESS_MODE_R_R, REG_A, REG_E},
        [0xB4] = {INSTRUCTION_OR, ADDRESS_MODE_R_R, REG_A, REG_H},
        [0xB5] = {INSTRUCTION_OR, ADDRESS_MODE_R_R, REG_A, REG_L},
        [0xB6] = {INSTRUCTION_OR, ADDRESS_MODE_MR, REG_A, REG_HL},
        [0xB7] = {INSTRUCTION_OR, ADDRESS_MODE_R_R, REG_A, REG_A},
        [0xB8] = {INSTRUCTION_CP, ADDRESS_MODE_R_R, REG_A, REG_B},
        [0xB9] = {INSTRUCTION_CP, ADDRESS_MODE_R_R, REG_A, REG_C},
        [0xBA] = {INSTRUCTION_CP, ADDRESS_MODE_R_R, REG_A, REG_D},
        [0xBB] = {INSTRUCTION_CP, ADDRESS_MODE_R_R, REG_A, REG_E},
        [0xBC] = {INSTRUCTION_CP, ADDRESS_MODE_R_R, REG_A, REG_H},
        [0xBD] = {INSTRUCTION_CP, ADDRESS_MODE_R_R, REG_A, REG_L},
        [0xBE] = {INSTRUCTION_CP, ADDRESS_MODE_MR, REG_A, REG_HL},
        [0xBF] = {INSTRUCTION_CP, ADDRESS_MODE_R_R, REG_A, REG_A},
        ...
        [0xCB] = {INSTRUCTION_CB, ADDRESS_MODE_D8},
        ...
        [0xD6] = {INSTRUCTION_SUB, ADDRESS_MODE_D8},
        ...
        [0xDE] = {INSTRUCTION_SBC, ADDRESS_MODE_R_D8, REG_A},
        ...
        [0xE6] = {INSTRUCTION_AND,ADDRESS_MODE_D8},
        ...
        [0xEE] = {INSTRUCTION_XOR,ADDRESS_MODE_D8},
        ...
        [0xFB] = {INSTRUCTION_EI},
        [0xFE] = {INSTRUCTION_CP, ADDRESS_MODE_D8},
